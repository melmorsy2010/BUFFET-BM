...
class _DrinksScreenState extends State<DrinksScreen70> with SingleTickerProviderStateMixin{
  ...
  final _drinksList70 = DrinksList70();
  final _juicelist70 = JUICEList70();
  ...
  void initState() {
    ...
    super.initState();
    _drinksList70.loadDrinks();
    _juicelist70.loadDrinks();
    _loadUserData();
    _fetchLink();
                    ...
                    child: Container(
                      child:   Column(
                        children: [
                          ...
                          Expanded(
                            child: FutureBuilder(
                              future: _drinksList70.loadDrinks(),
                              builder: (BuildContext context, AsyncSnapshot snapshot) {
                                ...
                                return ListView.builder(
                                  shrinkWrap: true,
                                  itemCount: _drinksList70.drinks.length,
                                  itemBuilder: (BuildContext context, int index) {
                                    final drink = _drinksList70.drinks[index];
                    ...
                    Container(
                      child:   Column(
                        children: [
                          ...
                          Expanded(
                            child: FutureBuilder(
                              future: _juicelist70.loadDrinks(),
                              builder: (BuildContext context, AsyncSnapshot snapshot) {
                                if (snapshot.connectionState == ConnectionState.waiting) {
                                  return Center(child: CircularProgressIndicator());
                                }
                                ...
                                return ListView.builder(
                                  shrinkWrap: true,
                                  itemCount: _juicelist70.juices.length,
                                  itemBuilder: (BuildContext context, int index) {
                                    final Juice = _juicelist70.juices[index];
